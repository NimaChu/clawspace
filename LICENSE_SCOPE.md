...
- the CLAWSPACE name, logos, mascot, or other brand identifiers as trademarks
...
Contributors must only submit code and assets they have the right to license. If a contribution includes third-party material, its source and license must be documented in the pull request and, when appropriate, in a notice file near the material.

## Example applications

Only applications deliberately placed under `examples/` are part of this repository's license grant. Applications previously hosted by a CLAWSPACE deployment are not automatically open source merely because the platform can launch or download them.
